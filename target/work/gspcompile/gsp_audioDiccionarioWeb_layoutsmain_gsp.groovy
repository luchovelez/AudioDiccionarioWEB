...
class gsp_audioDiccionarioWeb_layoutsmain_gsp extends GroovyPage {
...
createTagBody(2, {->
createTagBody(3, {->
invokeTag('layoutTitle','g',10,['default':("AudioDiccionario")],-1)
})
...
createTagBody(1, {->
printHtmlPart(7)
invokeTag('image','asset',20,['src':("grails_logo.png"),'alt':("FROAC")],-1)
printHtmlPart(8)
