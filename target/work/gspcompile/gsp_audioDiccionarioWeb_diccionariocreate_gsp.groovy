...
class gsp_audioDiccionarioWeb_diccionariocreate_gsp extends GroovyPage {
public String getGroovyPageFileName() { "/WEB-INF/grails-app/views/diccionario/create.gsp" }
public Object run() {
Writer out = getOut()
...
printHtmlPart(1)
invokeTag('set','g',5,['var':("entityName"),'value':(message(code: 'diccionario.label', default: 'Diccionario'))],-1)
printHtmlPart(1)
createTagBody(2, {->
createTagBody(3, {->
...
invokeTag('eachError','g',25,['bean':(diccionarioInstance),'var':("error")],3)
printHtmlPart(18)
})
invokeTag('hasErrors','g',27,['bean':(diccionarioInstance)],2)
printHtmlPart(11)
createTagBody(2, {->
printHtmlPart(19)
...
invokeTag('form','g',35,['url':([resource:diccionarioInstance, action:'save'])],2)
printHtmlPart(22)
})
